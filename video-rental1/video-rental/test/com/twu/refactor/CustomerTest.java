...
public class CustomerTest extends TestCase {
    ...
    public void testEmpty() throws Exception {
        ...
        equalsFile("1st Output", "outputEmpty", new TextStatement().getStatement(dinsdale.getRentalList(),dinsdale));
    }

    public void testCustomer() throws Exception {
        equalsFile("1st Output", "output1", new TextStatement().getStatement(dinsdale.getRentalList(), dinsdale));
    }
    ...
    public void testChange() throws Exception {
        ...
        equalsFile("1st Output", "outputChange", new TextStatement().getStatement(dinsdale.getRentalList(),dinsdale));
    }
